...
public class AllyGunController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        halfHealth = allyHealthSystem.health / 2;
    }
    ...
    private void Update()
    {
        ...
        if (EnemyOnShootingRange())
        {
            ...
            else
            {
                ...
                if (!allyHealthSystem.allyIsHurt)
                {
                    rb.velocity = Vector2.zero;
    ...
    private void CaptureTheFlag()
    {
        if (!OnCTFRange())
        {
            ...
            Vector2 headThroughFlag = (flagLocation.transform.position - allyPosition.transform.position).normalized * movementSpeed;
    ...
    private void Movesets()
    {
        ...
        if (halfHealth <= allyHealthSystem.health)
        {
            ForwardWhileShooting();
        }
        else
